...
static const _BallManagerStats_type_support_symbol_names_t _BallManagerStats_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tennis_court, msg, BallManagerStats)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tennis_court, msg, BallManagerStats)),
  }
};
...
{
  return &::tennis_court::msg::rosidl_typesupport_cpp::BallManagerStats_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tennis_court, msg, BallManagerStats)() {
  return get_message_type_support_handle<tennis_court::msg::BallManagerStats>();
}
